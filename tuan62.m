...
title({'The Analog Signal, \itM_a(t)'})
grid on
...
wc = 300 * pi; % Define the cutoff frequency
ot = wc / (2 * pi);
fsn = 600; % Define the sampling frequency
...
title({'The Finite Length Sequence, \it M_a[n] \rm \bf'; 'At \itf\rm\bf = 600Hz'}, 'fontname', 'Comic Sans MS', 'fontsize', 14)
grid on
xlabel('Time', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
...
grid on
title({'The DFT, \it M_a[\Omega] \rm \bf'; 'At \itf\rm\bf = 600Hz'}, 'fontname', 'Comic Sans MS','fontsize', 14)
xlabel('\omega', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
subplot(3,1,3)
plot(w1, angleH1, '-r', 'linewidth', 2)
grid on
title({'The Angle of, \it M_a[\Omega] \rm \bf'; 'At \itf\rm\bf = 600Hz'}, 'fontname', 'Comic Sans MS', 'fontsize', 14)
xlabel('\omega', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
