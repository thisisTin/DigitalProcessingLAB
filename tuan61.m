...
wc = 300 * pi; % Define the cutoff frequency
ot = wc / (2 * pi);
fsn = 200; % Define the sampling frequency
...
title({'The Finite Length Sequence, \it S_a[n] \rm \bf'; 'At \itf\rm\bf = 200Hz'}, 'fontname', 'Comic Sans MS', 'fontsize', 14)
grid on
xlabel('Time', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
...
grid on
title({'The DFT, \it S_a[\Omega] \rm \bf'; 'At \itf\rm\bf = 200Hz'}, 'fontname', 'Comic Sans MS','fontsize', 14)
xlabel('\omega', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
subplot(3,1,3)
plot(w1, angleH1, '-r', 'linewidth', 2)
grid on
title({'The Angle of, \it S_a[\Omega] \rm \bf'; 'At \itf\rm\bf = 200Hz'}, 'fontname', 'Comic Sans MS', 'fontsize', 14)
xlabel('\omega', 'fontname', 'Comic Sans MS', 'fontsize', 14)
ylabel('Amplitude', 'fontname', 'Comic Sans MS', 'fontsize', 14)
